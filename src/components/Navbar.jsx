  ...
  return (
    ...
    <div className="flex justify-between items-center pt-8 mb-12 max-md:mb-6 max-md:block">
        ...
        <nav className={`flex gap-10 max-md:flex-col max-md:mt-12 ${menuOpen ? "max-md:flex" : "max-md:hidden"} `}>
            ...
            <a href="#ec" className={`text-[#7e9199] hover:text-white pb-1 hover:border-b text-lg transition-all ${active === 3 ? "active" : "deactive"}`} onClick={() => handleLinkClick(3)}>
              E&C
            </a>
          ...
          <ul className={`hidden justify-around items-center mt-28 max-md:flex`}>
            <li><a href="https://github.com/jalaj-pandey/" className="text-4xl" target="_blank" rel="noreferrer"><FaGithub /></a></li>
            <li><a href="https://www.linkedin.com/in/jalaj-pandey/" className="text-4xl" target="_blank" rel="noreferrer"><FaLinkedin /></a></li>
            <li><a href="https://www.instagram.com/thejalajpandey/" className="text-4xl" target="_blank" rel="noreferrer"><FaInstagram /></a></li>
          </ul>
        </nav>  
